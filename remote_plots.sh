#!/bin/bash
#execution example
#./remote_plots.sh all 1000 0 73 10_onenet_standard prefit
...
echo " --------------"
echo " Running Shape extraction for id: ${MASS}_${MASS_H2}"
...
if [[ $MODE == *"postfit"* ]]; then
    PostFitShapesFromWorkspace -d fit_output/${TAG}/output_combined_${CHANNEL}_${TRAINING_MASS}_${TRAINING_BATCH}_nmssm_${MASS}_${MASS_H2}/combined/cmb/combined.txt.cmb -w fit_output/${TAG}/output_combined_${CHANNEL}_${TRAINING_MASS}_${TRAINING_BATCH}_nmssm_${MASS}_${MASS_H2}/combined/cmb/ws.root -o fit_output/${TAG}/output_combined_${CHANNEL}_${TRAINING_MASS}_${TRAINING_BATCH}_nmssm_${MASS}_${MASS_H2}/combined/cmb/postfitshape.root --freeze r_NMSSM_${MASS}_125_${MASS_H2}=1 --postfit -f ${FITFILE}:fit_s --skip-prefit --restrict-to-bin ${id}
elif [[ $MODE == *"prefit"* ]]; then
    PostFitShapesFromWorkspace -d fit_output/${TAG}/output_combined_${CHANNEL}_${TRAINING_MASS}_${TRAINING_BATCH}_nmssm_${MASS}_${MASS_H2}/combined/cmb/combined.txt.cmb -w fit_output/${TAG}/output_combined_${CHANNEL}_${TRAINING_MASS}_${TRAINING_BATCH}_nmssm_${MASS}_${MASS_H2}/combined/cmb/ws.root -o fit_output/${TAG}/output_combined_${CHANNEL}_${TRAINING_MASS}_${TRAINING_BATCH}_nmssm_${MASS}_${MASS_H2}/combined/cmb/${id}.root -f fit_output/${TAG}/output_combined_${CHANNEL}_${TRAINING_MASS}_${TRAINING_BATCH}_nmssm_${MASS}_${MASS_H2}/combined/cmb/higgsCombine.NMSSM_1000_125_.AsymptoticLimits.mH${MASS_H2} --freeze r_NMSSM_${MASS}_125_${MASS_H2}=1. --restrict-to-bin ${id}
fi
