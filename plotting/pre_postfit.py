...
def main(info):
    ...
    plot.save("plots/%s/%s/%s_plots_%s/%s/%s_%s_%s_%s.%s" % (args.tag,args.prepost,args.era, postfix, channel, args.era, channel, variable, category_dict[args.category_postfix], "pdf"))
    plot.save("plots/%s/%s/%s_plots_%s/%s/%s_%s_%s_%s.%s" % (args.tag,args.prepost,args.era, postfix, channel, args.era, channel, variable, category_dict[args.category_postfix], "png"))
