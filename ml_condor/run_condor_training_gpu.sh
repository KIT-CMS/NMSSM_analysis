...
NAME_USER=$3
FOLDER=$4
folder=${ERA_NAME}_${CHANNEL}
outdir=/tmp/${FOLDER}/${folder}
#---1---
cephdir=root://ceph-node-a.etp.kit.edu:1094//${NAME_USER}/${FOLDER}
...
for ERA in ${ERAS}; do
  loop_folder=${ERA}_${CHANNEL}
  loop_outdir=/tmp/${FOLDER}/${loop_folder}
  echo ${loop_outdir}
  mkdir -p ${loop_outdir}
...
echo "${cephdir}/${folder}/"
#cat ${cephdir}/${folder}/dataset_config.yaml
ls
#xrdcp ${cephdir}/${folder}/dataset_config.yaml root://ceph-node-a.etp.kit.edu:1094//${NAME_USER}
echo "config:${cephdir}/${folder}/dataset_config.yaml"
