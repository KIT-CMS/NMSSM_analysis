...
CALC=$3
FOLDER=$4
OUTPUT_PATH=output/ml/${FOLDER}/${ERA}_${CHANNEL}
...
TRANSFERED_FILES_OUT="condor_output_${ERA}_${CHANNEL}"
...
echo "${GPU_OFF}./${EXECUTABLE} ${ERA} ${CHANNEL} ${USER} ${FOLDER}" >> ${JOB_EXECUTABLE}
