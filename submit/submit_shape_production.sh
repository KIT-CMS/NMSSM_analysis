...
source utils/setup_samples.sh $ERA $CHANNEL $MHS
...
then
    ...
    echo $PROCESSES
    echo ${PROCS_ARR[@]}
   # echo $NNScore_Friends_nottclass
    ...
    sed -i '/^RequestMemory/c\RequestMemory = 6000' $OUTPUT/produce_shapes_cc7_multicore.jdl
