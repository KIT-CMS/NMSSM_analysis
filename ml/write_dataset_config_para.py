    ...
    def estimationMethodAndClassMapGenerator():
        ...
        if args.training_stxs1p1:
            ...
            mass_dict= {
                ...
                "light_mass_fine": [60, 70, 80, 90, 100, 120, 150, 170, 190, 250, 300, 350, 400, 450, 500, 550, 600, 650, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1600, 1800, 2000, 2200, 2400, 2600, 2800],
            }
            ...
            for heavy_mass in mass_dict["heavy_mass"]:      
                ...
                for light_mass in light_masses:
                    if light_mass+125<heavy_mass:
                        classes_map["NMSSM_{}_125_{}".format(heavy_mass,light_mass)] = "NMSSM"
